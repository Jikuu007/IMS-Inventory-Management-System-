...
- [Dowload file IMS RUN.rar](https://www.mediafire.com/file/vsgpa3dkajgp8hq/IMS_RUN.rar/file)
- แตก file แล้วเปิดตัว IMS RUN.exe
...
6. Save to file : เป็นการเซฟรายการสินค้า(ต้องเซฟทุกครั้ง)
